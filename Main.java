...
public class Main {
    ...
    public String generateAccountNumber(){
        return "ACC"+(100+numberOFAccounts);
    }
    ...
    public void withdrawAccount(String accountNumber,double amount){
        int accountIndex=findAccountIndex(accountNumber);
        if (accountIndex!=-1){
            if (amount<accountBalance[accountIndex]){
                accountBalance[accountIndex]-=amount;
                System.out.println("Withdrawal is successful. Current Balance: "+accountBalance[accountIndex]);
            }
            else {
    ...
    public void checkoutBalance(String accountNumber){
        int accountIndex=findAccountIndex(accountNumber);
        System.out.println("Balance: "+accountBalance[accountIndex]);
    }
        ...
        while(true) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    main.withdrawAccount(accountNumber2,amount2);
                    break;
                case 4:
                    System.out.println("Enter your account number: ");
                    String accountNumber3 = scanner.next();
                    main.checkoutBalance(accountNumber3);
                    break;
                case 5:
